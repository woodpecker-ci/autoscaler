...
// Firewall provides a mock function for the type MockClient
func (_mock *MockClient) Firewall() hcapi.FirewallClient {
	ret := _mock.Called()
	...
	if returnFunc, ok := ret.Get(0).(func() hcapi.FirewallClient); ok {
		r0 = returnFunc()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockClient_Firewall_Call) Return(firewallClient hcapi.FirewallClient) *MockClient_Firewall_Call {
	_c.Call.Return(firewallClient)
	return _c
}
...
// Image provides a mock function for the type MockClient
func (_mock *MockClient) Image() hcapi.ImageClient {
	ret := _mock.Called()
	...
	if returnFunc, ok := ret.Get(0).(func() hcapi.ImageClient); ok {
		r0 = returnFunc()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockClient_Image_Call) Return(imageClient hcapi.ImageClient) *MockClient_Image_Call {
	_c.Call.Return(imageClient)
	return _c
}
...
// Network provides a mock function for the type MockClient
func (_mock *MockClient) Network() hcapi.NetworkClient {
	ret := _mock.Called()
	...
	if returnFunc, ok := ret.Get(0).(func() hcapi.NetworkClient); ok {
		r0 = returnFunc()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockClient_Network_Call) Return(networkClient hcapi.NetworkClient) *MockClient_Network_Call {
	_c.Call.Return(networkClient)
	return _c
}
...
// SSHKey provides a mock function for the type MockClient
func (_mock *MockClient) SSHKey() hcapi.SSHKeyClient {
	ret := _mock.Called()
	...
	if returnFunc, ok := ret.Get(0).(func() hcapi.SSHKeyClient); ok {
		r0 = returnFunc()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockClient_SSHKey_Call) Return(sSHKeyClient hcapi.SSHKeyClient) *MockClient_SSHKey_Call {
	_c.Call.Return(sSHKeyClient)
	return _c
}
...
// Server provides a mock function for the type MockClient
func (_mock *MockClient) Server() hcapi.ServerClient {
	ret := _mock.Called()
	...
	if returnFunc, ok := ret.Get(0).(func() hcapi.ServerClient); ok {
		r0 = returnFunc()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockClient_Server_Call) Return(serverClient hcapi.ServerClient) *MockClient_Server_Call {
	_c.Call.Return(serverClient)
	return _c
}
...
// ServerType provides a mock function for the type MockClient
func (_mock *MockClient) ServerType() hcapi.ServerTypeClient {
	ret := _mock.Called()
	...
	if returnFunc, ok := ret.Get(0).(func() hcapi.ServerTypeClient); ok {
		r0 = returnFunc()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockClient_ServerType_Call) Return(serverTypeClient hcapi.ServerTypeClient) *MockClient_ServerType_Call {
	_c.Call.Return(serverTypeClient)
	return _c
}
