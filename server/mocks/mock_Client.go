...
func (_c *MockClient_Deploy_Call) Run(run func(repoID int64, pipeline int64, env string, params map[string]string)) *MockClient_Deploy_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(int64), args[1].(int64), args[2].(string), args[3].(map[string]string))
	})
	return _c
}
...
func (_c *MockClient_Deploy_Call) RunAndReturn(run func(int64, int64, string, map[string]string) (*woodpecker.Pipeline, error)) *MockClient_Deploy_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockClient_GlobalSecretList_Call) RunAndReturn(run func() ([]*woodpecker.Secret, error)) *MockClient_GlobalSecretList_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockClient_OrgSecretList_Call) RunAndReturn(run func(int64) ([]*woodpecker.Secret, error)) *MockClient_OrgSecretList_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockClient_PipelineLast_Call) RunAndReturn(run func(int64, string) (*woodpecker.Pipeline, error)) *MockClient_PipelineLast_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockClient_PipelineList_Call) RunAndReturn(run func(int64) ([]*woodpecker.Pipeline, error)) *MockClient_PipelineList_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockClient_PipelineStart_Call) RunAndReturn(run func(int64, int64, map[string]string) (*woodpecker.Pipeline, error)) *MockClient_PipelineStart_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockClient_RegistryList_Call) RunAndReturn(run func(int64) ([]*woodpecker.Registry, error)) *MockClient_RegistryList_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockClient_RepoListOpts_Call) Return(_a0 []*woodpecker.Repo, _a1 error) *MockClient_RepoListOpts_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockClient_RepoListOpts_Call) RunAndReturn(run func(bool) ([]*woodpecker.Repo, error)) *MockClient_RepoListOpts_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockClient_RepoPost_Call) RunAndReturn(run func(int64) (*woodpecker.Repo, error)) *MockClient_RepoPost_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockClient_SecretList_Call) RunAndReturn(run func(int64) ([]*woodpecker.Secret, error)) *MockClient_SecretList_Call {
	_c.Call.Return(run)
	return _c
}
